...
const Footer = () => {
  return (
    <footer
      className='bg-gray-100 text-center dark:bg-neutral-600 lg:text-left'
    >
      <div
        className='flex items-center p-6 pb-16 justify-between'
      >
        <a
          href='https://www.houstonhumane.org/?form=GeneralDonation'
          className='hover:scale-110 transition ease-in-out duration-300'
          target='_blank'
          rel='noopener noreferrer'
        >
          <svg
            viewBox='37 25 126 150'
            xmlns='http://www.w3.org/2000/svg'
            className='fill-neutral-800 h-20 w-20'
          >
            <g>
              <path
      ...
      <div
        className='bg-gray-100 p-4 font-poppins text-md text-center text-neutral-500 dark:bg-neutral-700 dark:text-neutral-200'
      >
